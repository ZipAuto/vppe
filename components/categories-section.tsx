...
const categories = [
  {
    name: 'Vaporizadores',
    description: 'Dispositivos recargables de alta calidad',
  ...
  {
    name: 'Bongs',
    description: 'Cristal y acrilico premium',
  ...
  {
    name: 'CBD',
    description: 'Aceites y productos de cannabidiol',
    href: '/categoria/cbd',
    icon: Leaf,
    count: '20+',
    featured: false,
  ...
  {
    name: 'E-Liquids',
    description: 'Sabores y sales de nicotina',
    href: '/categoria/e-liquids',
    icon: Sparkles,
    count: '80+',
    featured: false,
  },
  {
    name: 'Accesorios',
    description: 'Resistencias, cargadores y mas',
